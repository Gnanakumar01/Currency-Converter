...
function App() {
  ...
  useEffect(()=>{
    const getExchangeRate = async () => {
      try {
        let url = `https://api.exchangerate-api.com/v4/latest/${formCurrency}`
      ...
      <div className='currency-converter'>
        ...
        <div className='data'>
          ...
          <div className='input-container'>
            ...
            <select id="fromCurrency" value={formCurrency} onChange={handleFromCurrencyChange}>
          ...
          <div className='input-container'>
            ...
            <div className="result">
              <p>{amount} {formCurrency} is equal to {convertedAmount} {toCurrency}</p>
            </div>
          </div>
        </div>
      </div>
